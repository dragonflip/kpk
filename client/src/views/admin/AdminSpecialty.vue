      ...
      <table class="table">
        <thead>
          <tr>
            ...
            <th scope="col">Форма здобуття освіти</th>
            <th scope="col">Кваліфікація</th>
            <th scope="col">Термін навчання</th>
        ...
        <tbody>
          <tr>
            ...
            <td>
              3 роки 10 місяців – на основі базової загальної середньї освіти<br />
              2 роки 10 місяців – на основі повної загальної середньої освіти
            </td>
            <td>
              Фахівці можуть обіймати такі посади: технік-програміст, фахівець з
